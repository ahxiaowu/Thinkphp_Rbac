        ...
        <table cellspacing=0 cellpadding=0 width="100%" 
            ...
            <tr height=56>
                ...
                <td style="font-weight: bold; color: #fff; padding-top: 20px" 
                    align=middle>当前用户：<?php echo (session('username')); echo (date('Y-m-d g:i a',time())); ?> &nbsp;&nbsp; <a style="color: #fff" 
                                                        href="" 
                                                        ...
                                                        onclick="if (confirm('确定要退出吗？'))
                                                                    ...
                                                                    return false;" 
                                                        href="<?php echo U(GROUP_NAME.'/Manager/out');?>" target=_top>退出系统</a> 
                </td>
                <td align=right width=268><img height=56 
                                               src="__PUBLIC__/admin/img/header_right.jpg" width=268></td></tr></table>
